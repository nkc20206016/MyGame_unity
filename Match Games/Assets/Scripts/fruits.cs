...
public class fruits : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        while (myList.Count > 0)
        {
            ...
            if (i == 1)
            {
                Instantiate(myList[count], new Vector3(-7.31f, 1.4f, 0), Quaternion.identity);
            }

            if (i == 2)
            {
                Instantiate(myList[count], new Vector3(-7.02f, -3.06f, 0), Quaternion.identity);
            }

            if (i == 3)
            {
                Instantiate(myList[count], new Vector3(6.88f, -0.6f, 0), Quaternion.identity);
            }
