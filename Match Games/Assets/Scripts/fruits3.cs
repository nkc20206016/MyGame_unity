...
public class fruits3 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        while (myList.Count > 0)
        {
            ...
            if (i == 1)
            {
                Instantiate(myList[count], new Vector3(7.24f,1.946f, 0), Quaternion.identity);
            }

            if (i == 2)
            {
                Instantiate(myList[count], new Vector3(7.24f, -1.55f, 0), Quaternion.identity);
            }

            if (i == 3)
            {
                Instantiate(myList[count], new Vector3(-0.75f, 0.45f, 0), Quaternion.identity);
            }

            if (i == 4)
            {
                Instantiate(myList[count], new Vector3(-7.77f, -2.05f, 0), Quaternion.identity);
            }

            if (i == 5)
            {
                Instantiate(myList[count], new Vector3(-7.77f, 1.44f, 0), Quaternion.identity);
            }
